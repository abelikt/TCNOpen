...
typedef struct PUBLISH_TELEGRAM
{
    ...
    UINT32                  opTrnTopoCount;                 /* operational topocount, != 0 for orientation/direction
...
typedef struct SUBSCRIBE_TELEGRAM
{
    ...
    TRDP_IF_CONFIG_T            *pIfConfig;                         /* pointer to I/F Config */
    TRDP_PD_PAR_T               *pPdParameter;                      /* pointer to PD Parameter */
    void                        *pUserRef;                              /* user supplied value returned within the info
                                                                          structure */
    UINT32                      comId;                                  /* publish comId */
    UINT32                      etbTopoCount;               /* ETB topocount to use, 0 if consist local communication */
    UINT32                      opTrnTopoCount;             /* operational topocount, != 0 for orientation/direction
...
typedef struct WAITING_RECEIVE_REQUEST
{
    ...
    void                            *callerReference;                               /* caller Reference : message Queue
                                                                                      Handle */
...
extern PUBLISH_TELEGRAM_T       *pHeadPublishTelegram;                          /* Top Address of Publish Telegram List
                                                                                  */
extern SUBSCRIBE_TELEGRAM_T     *pHeadSubscribeTelegram;                            /* Top Address of Subscribe Telegram
                                                                                      List */
extern PD_REQUEST_TELEGRAM_T    *pHeadPdRequestTelegram;                            /* Top Address of PD Request
                                                                                      Telegram List */
extern CALLER_TELEGRAM_T        *pHeadCallerTelegram;                               /* Top Address of Subscribe Telegram
                                                                                      List */
