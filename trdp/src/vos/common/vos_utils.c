...
static void vos_printStructSizes ()
{
    ...
    vos_printLog(VOS_LOG_DBG, "\t%-22s:\t%lu\n", "TRDP_SESSION_T", (unsigned long) sizeof(TRDP_SESSION_T));
    vos_printLog(VOS_LOG_DBG, "\t%-22s:\t%lu\n", "TRDP_SOCKETS_T", (unsigned long) sizeof(TRDP_SOCKETS_T));
    vos_printLog(VOS_LOG_DBG, "\t%-22s:\t%lu\n", "TRDP_SEQ_CNT_LIST_T", (unsigned long) sizeof(TRDP_SEQ_CNT_LIST_T));
    vos_printLog(VOS_LOG_DBG, "\t%-22s:\t%lu\n", "TRDP_SEQ_CNT_ENTRY_T", (unsigned long) sizeof(TRDP_SEQ_CNT_ENTRY_T));
    vos_printLog(VOS_LOG_DBG, "\t%-22s:\t%lu\n", "PD_ELE_T", (unsigned long) sizeof(PD_ELE_T));
    vos_printLog(VOS_LOG_DBG, "\t%-22s:\t%lu\n", "PD_PACKET_T", (unsigned long) sizeof(PD_PACKET_T));
#if MD_SUPPORT
    vos_printLog(VOS_LOG_DBG, "\t%-22s:\t%lu\n", "MD_ELE_T", (unsigned long) sizeof(MD_ELE_T));
    vos_printLog(VOS_LOG_DBG, "\t%-22s:\t%lu\n", "MD_LIS_ELE_T", (unsigned long) sizeof(MD_LIS_ELE_T));
#endif
#ifdef HIGH_PERF_INDEXED
    vos_printLog(VOS_LOG_DBG, "\t%-22s:\t%lu\n", "TRDP_HP_SLOTS_T", (unsigned long) sizeof(TRDP_HP_SLOTS_T));
